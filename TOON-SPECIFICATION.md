...
> **Note:** This document describes the TOON format itself. For Java implementation details, see the [JToon library README](README.md).
...
> [!TIP]
> For large uniform tables, tab delimiters can tokenize better than commas and reduce the need for quote-escaping. Tell the model "fields are tab-separated."
