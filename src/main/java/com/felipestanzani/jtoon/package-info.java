 ...
 * <h3>Public API</h3>
 * <ul>
 * <li>{@link com.felipestanzani.jtoon.JToon} - Main entry point for encoding
 * Java objects to TOON format</li>
 * <li>{@link com.felipestanzani.jtoon.EncodeOptions} - Configuration options
 * for encoding (indent, delimiter, length marker)</li>
 * <li>{@link com.felipestanzani.jtoon.Delimiter} - Enum for array/tabular
 * delimiter options (comma, tab, pipe)</li>
 * </ul>
 * 
 * <h3>Encoding Pipeline</h3>
 * <ul>
 * <li>{@link com.felipestanzani.jtoon.normalizer.JsonNormalizer} - Converts
 * Java objects to Jackson JsonNode representation</li>
 * <li>{@link com.felipestanzani.jtoon.encoder.ValueEncoder} - Core encoder that
 * converts JsonNode to TOON format</li>
 * <li>{@link com.felipestanzani.jtoon.encoder.PrimitiveEncoder} - Handles
 * encoding of primitive values and object keys</li>
 * <li>{@link com.felipestanzani.jtoon.encoder.HeaderFormatter} - Formats array
 * and tabular structure headers</li>
 * <li>{@link com.felipestanzani.jtoon.encoder.LineWriter} - Accumulates
 * indented lines for output</li>
 * </ul>
 * 
 * <h3>Utility Classes</h3>
 * <ul>
 * <li>{@link com.felipestanzani.jtoon.util.StringValidator} - Validates when
 * strings can be unquoted</li>
 * <li>{@link com.felipestanzani.jtoon.util.StringEscaper} - Escapes special
 * characters in quoted strings</li>
 * <li>{@link com.felipestanzani.jtoon.util.Constants} - Shared constants used
 ...
 * String toon = JToon.encode(data, options);
 * 
 ...
 * <h2>See Also</h2>
 * <ul>
 * <li><a href="https://github.com/felipestanzani/JToon">JToon GitHub
 * Repository</a></li>
 * <li><a href=
 * "https://github.com/felipestanzani/JToon/blob/main/TOON-SPECIFICATION.md">TOON
 * Format Specification</a></li>
 * <li><a href=
 * "https://central.sonatype.com/artifact/com.felipestanzani/jtoon">Maven
 * Central</a></li>
 * </ul>
 * 
 * @since 0.1.0
