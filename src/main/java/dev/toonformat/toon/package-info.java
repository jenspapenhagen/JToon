 ...
 * <h3>Public API</h3>
 * <ul>
 * <li>{@link dev.toonformat.toon.JToon} - Main entry point for encoding
 * Java objects to TOON format</li>
 * <li>{@link dev.toonformat.toon.EncodeOptions} - Configuration options
 * for encoding (indent, delimiter, length marker)</li>
 * <li>{@link dev.toonformat.toon.Delimiter} - Enum for array/tabular
 * delimiter options (comma, tab, pipe)</li>
 * </ul>
 * 
 * <h3>Encoding Pipeline</h3>
 * <ul>
 * <li>{@link dev.toonformat.toon.normalizer.JsonNormalizer} - Converts
 * Java objects to Jackson JsonNode representation</li>
 * <li>{@link dev.toonformat.toon.encoder.ValueEncoder} - Core encoder that
 * converts JsonNode to TOON format</li>
 * <li>{@link dev.toonformat.toon.encoder.PrimitiveEncoder} - Handles
 * encoding of primitive values and object keys</li>
 * <li>{@link dev.toonformat.toon.encoder.HeaderFormatter} - Formats array
 * and tabular structure headers</li>
 * <li>{@link dev.toonformat.toon.encoder.LineWriter} - Accumulates
 * indented lines for output</li>
 * </ul>
 * 
 * <h3>Utility Classes</h3>
 * <ul>
 * <li>{@link dev.toonformat.toon.util.StringValidator} - Validates when
 * strings can be unquoted</li>
 * <li>{@link dev.toonformat.toon.util.StringEscaper} - Escapes special
 * characters in quoted strings</li>
 * <li>{@link dev.toonformat.toon.util.Constants} - Shared constants used
 ...
 * <h2>See Also</h2>
 * <ul>
 * <li><a href="https://github.com/toon-format/toon-java">Toon-Java GitHub
 * Repository</a></li>
 * <li><a href=
 * "https://github.com/toon-format/toon-java/blob/main/TOON-SPECIFICATION.md">TOON
 * Format Specification</a></li>
 * <li><a href=
 * "https://central.sonatype.com/artifact/toon-format/toon-java">Maven
 * Central</a></li>
 * </ul>
 * 
 * @since 0.1.0
