...
public final class ListItemEncoder {
     ...
     */
    public static void encodeObjectAsListItem(final ObjectNode obj, final LineWriter writer, final int depth, final EncodeOptions options) {
     ...
     */
    private static void encodeFirstKeyValue(final String key, final JsonNode value, final LineWriter writer, final int depth,
    ...
    private static void encodeFirstValueAsPrimitive(final String encodedKey, final JsonNode value, final LineWriter writer, final int depth,
                                                    final EncodeOptions options) {
    ...
    private static void encodeFirstValueAsArray(final String key, final String encodedKey, final ArrayNode arrayValue, final LineWriter writer,
                                                final int depth, final EncodeOptions options) {
    ...
    private static void encodeFirstArrayAsPrimitives(final String key, final ArrayNode arrayValue, final LineWriter writer, final int depth,
                                                     final EncodeOptions options) {
    ...
    private static void encodeFirstArrayAsObjects(final String key, final String encodedKey, final ArrayNode arrayValue,
    ...
    private static void encodeFirstArrayAsComplex(final String encodedKey, final ArrayNode arrayValue, final LineWriter writer,
                                                  final int depth, final EncodeOptions options) {
    ...
    private static void encodeFirstValueAsObject(final String encodedKey, final ObjectNode nestedObj, final LineWriter writer, final int depth,
                                                 final EncodeOptions options) {
